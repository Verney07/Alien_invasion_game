...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.game_active:
            ...
            self.sb.prep_score()
            # Update levelimage properly at the start of a new game.
            self.sb.prep_level()
            # Show the player how many ships they have to start with.
            self.sb.prep_ships()
            # Change the boolean value of 'self.game_active'.
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            ...
            # Increase level: if a fleet destroyed, increment the value of
            # 'stats.level' and call 'prep_level()' to make sure the new
